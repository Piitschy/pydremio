...
```bash
pip install --upgrade --force-reinstall https://github.com/continental/pydremio/releases/download/v0.3.4/dremio-0.3.4-py3-none-any.whl
```
...
pip install --upgrade --force-reinstall \
  ...
  --cert False \
  https://github.com/continental/pydremio/releases/download/v0.3.4/dremio-0.3.4-py3-none-any.whl
```
